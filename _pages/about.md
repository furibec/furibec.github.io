...
### News:
I am co-organizing with [Matthias Chung](https://intranet.math.vt.edu/people/mcchung/) a virtual mini-symposium on: "*advances in sampling methods and prior models for large-scale Bayesian inverse problems*", for the [SIAM CSE21](https://www.siam.org/conferences/cm/conference/cse21) conference. Looking forward to it.
